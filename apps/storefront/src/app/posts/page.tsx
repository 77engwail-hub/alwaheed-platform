...
نوفر في ورشنا بفج عطان كافة مقاسات حجر الحبش الأسود بقص ليزري متقن وطبزة يدوية متناسقة.`,
    images: [
...
تم النحت بأيدي أمهر معلمي النحت اليدوي في ورشنا باستخدام حجر أبيض سيلاني نقي، مع مراعاة أدق تفاصيل الأوراق النباتية الكورنثية المتدرجة.
...
نستقبل طلبات تشكيل التيجان والأعمدة المخصصة حسب المقاسات والمخططات الهندسية.`,
    ...
    tags: ['تيجان_رومانية', 'نحت_يدوي', 'مشاريع_صنعاء', 'أعمدة_حجرية'],
    likesCount: 56,
    commentsCount: 1,
    isPinned: false,
    isPublished: true,
