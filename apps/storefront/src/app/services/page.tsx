...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      title: 'نحت التيجان والأعمدة والقواعد الرومانية',
      description:
        'نحت يدوي وآلي دقيق لتيجان الأعمدة الكورنثية والإسلامية والأقواس الملكية للمداخل والشرفات بأيدي نخبة من أمهر النحاتين.',
      features: ['نقوش ثلاثية الأبعاد بارزة', 'مقاسات وأقطار متنوعة', 'صلابة وجودة صخرية عالية'],
    },
    {
