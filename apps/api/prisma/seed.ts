...
async function main() {
  ...
  const finishes = [
    ...
    {
      nameAr: 'نحت زخرفي بارز وغائر (يدوي)',
      nameEn: 'Bas-Relief Hand Carved',
      slug: 'bas-relief-carved',
      descriptionAr: 'نحت فني ثلاثي الأبعاد بأيدي نخبة من أمهر النحاتين للزخارف والأقواس والتيجان.',
    },
    {
  ...
  const categories = [
    ...
    },
    {
      ...
      descriptionAr: 'نقوش حجرية يدوية وهندسية ونباتية وإسلامية ثلاثية الأبعاد بدقة وإتقان لا يضاهى.',
      sortOrder: 3,
  ...
  const products = [
    {
      titleAr: 'تاج عمود كورنثي ملكي منحوت يدوياً',
      titleEn: 'Hand-Carved Royal Corinthian Column Capital',
      slug: 'royal-corinthian-capital',
      sku: 'CAP-COR-001',
      shortDescAr: 'تاج عمود حجري فاخر بتفاصيل نباتية دقيقة منحوتة يدوياً من حجر بيج مأربي صلب.',
    ...
    },
    {
      ...
      sku: 'FOU-ROY-006',
      shortDescAr: 'نافورة حجرية متدرجة ثلاثية الطبقات منحوتة يدوياً للحدائق ومداخل القصور والفلل.',
  ...
  const projects = [
    ...
    },
    {
      ...
      fullDescAr: 'تم تصميم ونحت مدخل رئيسي بارتفاع 7 أمتار يتضمن 4 أعمدة رئيسية متدرجة وتيجاناً منحوتة يدوياً مع حزام كورنيشي مزخرف بنقوش هندسية دقيقة.',
